...
#define DELTA
  ...
  #define DELTA_HEIGHT 292.5 // get this value from auto calibrate
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -17.50  // Z offset: -below +above  [the nozzle], Anycubic Leveling Module v1:-18.0, v2:-14.9
