...
#define STRING_CONFIG_H_AUTHOR "(geeetech, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PI3 Pro X2"
...
#define HOTEND_OFFSET_X {0.0, 32.5} // (in mm) for each extruder, offset of the hotend on the X axis
